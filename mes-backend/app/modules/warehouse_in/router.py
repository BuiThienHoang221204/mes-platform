...
nhận thành phẩm của chính lô mình giao (§9b.1).
    ...
    POST /warehouse-in/{code}/complete      nhận hàng về kho
...
from app.modules.warehouse_in.schemas import (
    WarehouseInCompleteIn,
    WarehouseInCompleteOut,
)
...
def complete(code: str, body: WarehouseInCompleteIn, db: DbDep,
                     actor: ActorDep) -> WarehouseInCompleteOut:
    ...
    out = warehouse_in_service.complete(
        db, code=code, qty_received=body.qty_received,
