  ...
  return (
    ...
    >
      {isError ? (
        ...
        <ul
          className={
            fill ? "min-h-0 flex-1 overflow-auto" : "max-h-[30rem] overflow-auto"
          }
        >
          {rows.map((r) => (
            <li key={r.code} className="border-b border-line last:border-b-0">
              <button
                ...
                className="flex min-h-touch w-full flex-wrap items-center gap-x-4 gap-y-2 px-5 py-3 text-left hover:bg-surface-2"
              >
